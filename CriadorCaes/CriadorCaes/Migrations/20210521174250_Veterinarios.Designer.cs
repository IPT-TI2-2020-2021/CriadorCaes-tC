...
namespace CriadorCaes.Migrations
{
    ...
    [Migration("20210521174250_Veterinarios")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CaesVeterinarios", b =>
                {
                    b.Property<int>("ListaDeCaesTratadosId")
                        .HasColumnType("int");

                    b.Property<int>("ListaVetsId")
                        .HasColumnType("int");

                    b.HasKey("ListaDeCaesTratadosId", "ListaVetsId");

                    b.HasIndex("ListaVetsId");
            ...
            modelBuilder.Entity("CaesVeterinarios", b =>
                {
                    b.HasOne("CriadorCaes.Models.Caes", null)
                        .WithMany()
                        .HasForeignKey("ListaDeCaesTratadosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CriadorCaes.Models.Veterinarios", null)
                        .WithMany()
                        .HasForeignKey("ListaVetsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
